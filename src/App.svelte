      ...
      <div class="flex flex-col items-start justify-center transition-all duration-300 gap-x-4 gap-y-20 xl:flex-row xl:gap-y-0">
        <div class="w-full xl:max-w-[50%] px-2">
          ...
          <label class="relative group">
            ...
            <input id="taskInput" on:keypress={inputKeyDown} type="text" placeholder="Add Task" class="placeholder:text-brand-11 text-brand-12 pl-10 w-full h-[38px] rounded-md bg-brand-3 focus:outline-none focus:ring-2 focus:ring-brand-7">
          </label>
          <!-- task list -->
