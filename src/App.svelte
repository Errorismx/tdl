    ...
    <div class="h-[134px] flex items-center justify-start px-2 relative">
      ...
      <div class="absolute right-0">
        <div class="flex flex-col items-end justify-center">
          ...
          <button on:click={()=>{window.location.href = 'https://portfolio.errorism.cc/'}} class="flex items-center gap-1 transition-all duration-300 group text-base-9 hover:scale-110 hover:text-base-12">
